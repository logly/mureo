...
class TestListTools:
    ...
    async def test_list_tools_returns_all_tools(self) -> None:
        ...
        + Rollback 2 + Batch 3 + Change Import 1 + Analysis 5 + Mureo Context 13
        + Analytics Registry 2 + Learning 2 + Learning pre-flight 1
        + Creative Studio 5 = 226).

        Mureo Context is 13 since #638 added
        ...
        reads, as opposed to the prose an agent writes for itself).
