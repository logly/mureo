...
class TestListTools:
    ...
    async def test_list_tools_returns_all_tools(self) -> None:
        ...
        + Rollback 2 + Batch 3 + Change Import 1 + Analysis 1 + Mureo Context 9
        + Analytics Registry 2 + Learning 2 + Creative Studio 5 = 209).

        Analytics Registry is 2: mureo_analytics_modules_list +
        mureo_analytics_run (#440). Batch is 3: mureo_batch_begin / _end /
        _status (#549). Change Import is 1:
        mureo_external_changes_import (#545)."""
