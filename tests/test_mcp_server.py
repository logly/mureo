...
class TestListTools:
    ...
    async def test_list_tools_returns_all_tools(self) -> None:
        ...
        + Rollback 2 + Analysis 5 + Mureo Context 9 + Analytics Registry 2
        + Learning 2 + Learning pre-flight 1 + Creative Studio 5 = 215).

        Analytics Registry is 2: mureo_analytics_modules_list +
        mureo_analytics_run (#440). Analysis is 5: analysis_anomalies_check +
