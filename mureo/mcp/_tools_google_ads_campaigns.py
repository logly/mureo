...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        description=(
            ...
            "preserved. Returns the updated campaign record. Mutating — not "
            "automatically reversible; record before-state with "
            "mureo_state_action_log_append if you may need to roll back. "
            "For status-only changes (ENABLED / PAUSED / "
    ...
    Tool(
        ...
        description=(
            ...
            "the new ad_group's resource_name and id. Mutating — not "
            "automatically reversible; record before-state with "
            "mureo_state_action_log_append if you may need to roll back. "
            "The parent campaign must be ENABLED or PAUSED; "
    ...
    Tool(
        ...
        description=(
            ...
            "ad group. Mutating — not automatically reversible; record "
            "before-state with mureo_state_action_log_append if you may "
            "need to roll back. Does not "
    ...
    Tool(
        ...
        description=(
            ...
            "back. Google Ads requires 3–15 headlines and 2–4 descriptions. "
    ...
    Tool(
        ...
        description=(
            ...
            "id, and the generated asset IDs. Mutating — not automatically "
