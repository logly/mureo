...
the user-supplied CSV exports normalized into
...
class ByodSearchConsoleClient:
    """CSV-backed read-only mock of SearchConsoleApiClient."""

    SITE_URL = "sc-domain:byod.example.com"
    ...
    async def submit_sitemap(self, site_url: str, feedpath: str) -> dict[str, Any]:
        return {
            ...
            "note": "Sitemap submissions are disabled in BYOD mode.",
        }
    ...
    async def inspect_url(self, site_url: str, inspection_url: str) -> dict[str, Any]:
        return {
            ...
            "note": "URL inspection is not available in BYOD mode.",
        }

    async def close(self) -> None:
        return None

    async def __aenter__(self) -> ByodSearchConsoleClient:
        return self
